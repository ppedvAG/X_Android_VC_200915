...
namespace X_Android
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Button Btn_Google = FindViewById<Button>(Resource.Id.content_main_Btn_Google);
            ...
            Button Btn_RandomPic = FindViewById<Button>(Resource.Id.content_main_Btn_RandomPic);

            Intent explizieterIntent = new Intent(this, typeof(ShowRandomPicActivity));

            Btn_RandomPic.Click += (s, e) => StartActivity(explizieterIntent);
        }
